...
const Pricing = () => {
  ...
  return (
    <div className="lg:px-20 px-5 py-10 bgOpacity2 h-auto">
      <div className="w-full lg:h-[80px] border border-[#7c22de] lg:rounded-[30px] rounded-[10px] flex lg:flex-row flex-col h-auto justify-between items-center transAll">
        <p
      ...
      <div
        className="priceDiv basicPrice w-full h-auto border border-[#7c22de] lg:rounded-[30px] rounded-[10px] justify-between items-center transAll lg:p-10 p-6 text-white mt-3"
        style={{ display: activeButton === "Basic" ? "block" : "none" }}
      >
        <div className="flex items-start ">
          <div className="lg:w-[60%]">
            <p className="lg:text-4xl text-2xl tracking-wider font-bold font-clash">Static Page Service</p>
      ...
      <div
        className="priceDiv standPrice w-full h-auto border border-[#7c22de] lg:rounded-[30px] rounded-[10px] justify-between items-center transAll lg:p-10 p-6 text-white mt-3"
        style={{ display: activeButton === "Standard" ? "block" : "none" }}
      >
        <div className="flex items-start ">
          <div className="lg:w-[60%]">
            <p className="lg:text-4xl text-2xl tracking-wider font-bold font-clash">Standard Dynamic Site Service</p>
            <p className="lg:text-lg text-base font-normal mt-3 font-space">
            ...
            <p className="lg:text-lg text-base font-normal mt-5 font-space">
              ...
              features and interactive components to create a more engaging user
              experience.
            </p>
      ...
      <div
        className="priceDiv prePrice w-full h-auto border border-[#7c22de] lg:rounded-[30px] rounded-[10px] justify-between items-center transAll lg:p-10 p-6 text-white mt-3"
        style={{ display: activeButton === "Premium" ? "block" : "none" }}
      >
        <div className="flex items-start ">
          <div className="lg:w-[60%]">
            <p className="lg:text-4xl text-2xl tracking-wider font-bold font-clash">Premium Dynamic Site Service</p>
            <p className="lg:text-lg text-base font-normal mt-3 font-space">
