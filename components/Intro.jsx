  ...
  return (
    <div className=" bgOpacity2 text-white py-16 lg:py-32 ">
      <div className="max-container px-5 lg:px-24">
        <div className=" lg:mt-10 mb-5 lg:mb-10 font-semibold  text-3xl lg:text-[55px] font-clash">
          Who we are?
        </div>
        <div className="font-space">
          <div className="onScrollTypeWritterEffect lg:w-[70%] text-xl lg:text-[17px]">
            Welcome to our Digital Realm! As full-stack developers turned
            entrepreneurs, we craft bespoke and cutting-edge web solutions. With
            a passion for innovation and a commitment to excellence, we're here
            to elevate your online presence and drive your business towards
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mt-20">
          <div className="intro-container relative bg-[#2A153F] w-[100%] h-[450px]  rounded-[30px]">
            ...
            <div className="px-8 mt-4 space-y-1">
              ...
              <p className="text-white headings whitespace-nowrap tracking-wide text-base ">
                Developer
              </p>
            </div>
