...
const ChooseUs = () => {
  ...
  useEffect(() => {
    ...
    // Make each child element draggable
  ...
  return (
    <div className="bg-black">
      <div className="max-container px-6 lg:px-14 py-20">
        ...
        >
          <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-2">
            <div className="text-center p-20 border-r border-white border-b draggable">
            ...
            <div className="text-center p-20 border-l border-white border-b draggable">
              <h3 className="text-2xl font-platiPy font-semibold mb-2">
                Custom Solutions
              </h3>
              <p className="font-space text-lg">
            ...
            <div className="text-center p-20 border-r border-white border-t draggable">
              <h3 className="text-2xl font-platiPy font-semibold mb-2">
                Latest Technologies
              </h3>
              <p className="font-space text-lg">
            ...
            <div className="text-center p-20 border-l border-white border-t draggable">
              <h3 className="text-2xl font-platiPy font-semibold mb-2">
                Client Satisfaction
              </h3>
              <p className="font-space text-lg">
